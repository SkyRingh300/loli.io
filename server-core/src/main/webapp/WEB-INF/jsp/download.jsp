...
<body>
  ...
  <div class="container">
    <div class="download">
      ...
      <br />
      <p>
        这是一个<strong>截图客户端</strong>，可以运行在XP之后的(不包括XP)Windows、Mac、Linux上。<br /> 需要安装<a target="_blank"
      ...
      <p>
        <span> 最新版本为0.0.1-ALPHA，问题反馈请发送邮件至<a href="mailto:loli@linux.com" target="_blank">loli@linux.com</a></span>
      </p>
      <ul>
        <li><a href="http://1.loli.io/io.loli.sc-0.0.1.zip">zip</a></li>
        <li><a href="http://1.loli.io/io.loli.sc-0.0.1.tar.gz">tar.gz</a></li>
        <li><a href="http://1.loli.io/io.loli.sc-0.0.1-win.zip">Windows zip</a></li>
        <li><a href="http://1.loli.io/io.loli.sc-0.0.1.exe">Windows installer</a></li>
      </ul>
